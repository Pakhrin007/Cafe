...
const AboutUs = () => {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-center p-[30px]">
          <div className="h-px bg-gray-300 w-52"></div>
          <h1 className="text-[20px] font-body text-gray-800 px-6 uppercase font-title">Our Mission</h1>
          <div className="h-px bg-gray-300 w-52 "></div>
        </div>
        ...
        <div className="flex items-center justify-center p-[30px]">
          <div className="h-px bg-gray-300 w-52"></div>
          <h1 className="text-[20px] font-body text-gray-800 px-6 uppercase font-title">Our Locations</h1>
          <div className="h-px bg-gray-300 w-52 "></div>
        </div>
      <a href="https://maps.app.goo.gl/kWaEPGNyD8onWf416">
      <img src={location} alt="location" className="w-[1500px] h-[500px] object-contain mb-[30px]"  />
      </a>
      </div>
    </div>
  );
